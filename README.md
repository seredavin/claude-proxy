...
- **Маскирование IP, хостов и секретов.** С файлом правил шлюз подменяет в
  ...
  С ключом маскирования суррогаты адресов и хостов одинаковы во всех
  запусках и обратимы только владельцем ключа —
  [ключ маскирования](docs/advanced.md#ключ-маскирования).
...
| `claude-proxy gen-mask-key` | Сгенерировать ключ маскирования |
